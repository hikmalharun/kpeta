...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['rekap_all_masuk'] = $this->db->get_where('absen_masuk', ['bulan' => date('m'), 'tahun' => date('Y')])->result_array();
        $data['rekap_all_pulang'] = $this->db->get_where('absen_pulang', ['bulan' => date('m'), 'tahun' => date('Y')])->result_array();
